...
$fpdf->Write(0,'Empresas','http://localhost/ProyectoFinal/contactos.php');
$fpdf->Ln(10);
...
$fpdf->Cell(35,6, 'Nombre',0,0,'C',false);
$fpdf->Cell(35,6, 'Contacto',0,0,'C',false);
$fpdf->Cell(40,6, 'Localizacion',0,0,'C',false);
$fpdf->Cell(20,6, 'Telefono1',0,0,'C',false);
$fpdf->Cell(20,6, 'Telefono2',0,0,'C',false);
$fpdf->Cell(45,6, 'Email',0,0,'C',false);
$fpdf->Cell(55,6, 'Observaciones',0,0,'C',false);
$fpdf->Cell(20,6, 'Fecha',0,0,'C',false);

$fpdf->SetDrawColor(66, 123, 245);
$fpdf->SetLineWidth(1);
$fpdf->Line(10,48,290,48);
...
foreach ($contactos as $contacto) {
    ...
    $fpdf->Cell(35,10, $contacto->getNombre(),'B',0,'C',false);
    $fpdf->Cell(35,10, $contacto->getContacto(),'B',0,'C',false);
    $fpdf->Cell(40,10, $contacto->getLocalizacion(),'B',0,'C',false);
    $fpdf->Cell(20,10, $contacto->getTelefono1(),'B',0,'C',false);
    $fpdf->Cell(20,10, $contacto->getTelefono2(),'B',0,'C',false);
    $fpdf->Cell(45,10, $contacto->getEmail(),'B',0,'C',false);
    $fpdf->Cell(55,10, $contacto->getObservaciones(),'B',0,'C',false);
    $fpdf->Cell(20,10, $contacto->getFecha(),'B',0,'C',false);
    $fpdf->Ln();
}
