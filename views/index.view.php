...
<!--                        <div class="btn-group  mb-4 pr-2" role="group" aria-label="Button group with nested dropdown">-->
                            <div class="btn-group mx-3" role="type" aria-label="type of data">
...
<!--                        </div>-->
                        ...
                        <a href="pdf.php?search=" id="pdf" class="mx-3 d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generar PDF</a>
                    </div>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Kevin Oltra 2019</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
