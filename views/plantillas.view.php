...
<head>
    ...
    <title>Admin FCTs - Plantillas</title>
                ...
                <div class="row">
                    ...
                    <div class=" justify-content-end botones" style="right: 0">
                        <div class="">
                            ...
                            <div class="btn-group m-2" role="plantillas" aria-label="">
                                <a href="add-plantilla.php" class="btn btn-light shadow-sm ">Añadir Plantillas <i class="fas fa-user"></i></a>
...
<!--                            <a href="pdf-contactos.php?search=" id="pdf" class="m-2  d-inline-block btn btn-sm btn-primary shadow-sm "><i class="fas fa-download fa-sm text-white-50"></i> Generar PDF</a>-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 table-container">
                        <div id="listaPlantillas" class=""></div>
                    </div>
                </div>
...
<!-- Show Table -->
<script src="js/lista-plantillas.js"></script>
