...
<head>
    ...
    <title>Admin FCTs - Editar Empresas</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form id="edit-empresa" method="post" >
                    <!-- Content Row -->
                    <div class="row ">
...
<!--                            </div>-->
                            <div class="row ">
                                <div class="form-group col-md-12 col-lg-6 mt-4 ">
                                    ...
                                    <input type="text" class="form-control" id="cif" name="cif" value="<?= $_GET['cif'] ?? ''?>">
                                </div>
                                <div class="form-group col-md-12 col-lg-6 mt-4 ">
                                ...
                                <div class="form-group col-md-12 col-lg-6 mt-4">
                                    ...
                                    <select class="form-control" name="ciclos" id="ciclos" multiple>
                                        ...
                                        <?php foreach ($ciclos as $ciclo) {
                                            $existe = false;
                                             foreach ($empresaciclos as $empresaciclo) {
                                                 if ($ciclo->getId() == $empresaciclo->getId()){
                                                     $existe = true;
                                                 }
                                             }  ?>
                                            <option value="<?= $ciclo->getId() ?>" <?= $existe ?'selected' : '' ?>>
                                                <?= $ciclo->getCiclo() ?>
                                            </option>
                                        <?php } ?>
                                    </select>
...
<!-- js profile -->
<script src="js/edit-empresa.js"></script>
</body>
