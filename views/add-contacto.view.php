...
<head>
    ...
    <title>Admin FCTs - Añador Contacto</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">Añadir Contacto</h1>
...
<!--                                    <input type="text" class="form-control" id="nombre" name="nombre" value="">-->
                                    <select class="form-control" id="nombre" name="nombre">
                                        <option value="" hidden>--- Selecciona empresa ---</option>
                                        <?php foreach ($empresas as $empresa) { ?>
                                            <option value="<?= $empresa->getCif() ?>" data-empresa='<?= json_encode($empresa->toArray()) ?>' >
                                                <?= $empresa->getNombre() ?>
                                            </option>
                                        <?php } ?></select>
...
<!-- js profile -->
<script src="js/add-contacto.js"></script>
</body>
